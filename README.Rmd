...
[![CRAN status](https://www.r-pkg.org/badges/version/Rfactor)](https://CRAN.R-project.org/package=Rfactor)
...
-   `rf_calculate_ei30()` — calculate event energy, intensities, EI30,
    and erosive-event classification;
...
`Rfactor` has been empirically compared with
[RIST (Rainfall Intensity Summarization Tool)](https://www.ars.usda.gov/southeast-area/oxford-ms/national-sedimentation-laboratory/watershed-physical-processes-research/research/rist/rist-rainfall-intensity-summarization-tool/)
...
`Rfactor` is free software licensed under the GNU General Public License,
